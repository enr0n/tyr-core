class strings(object):
    ...
    # Queue
    Q_INIT = 'Initializing test queue...'
    Q_RECV = 'Received queue request.'
    WORKER_INIT = 'Initializing queue worker...'
    ...
    TEST_SEND_OUT = 'Sending test output to client'
    TEST_SEND_ERR = 'Sending error output to client'
    TEST_INIT = 'Initializing test '
